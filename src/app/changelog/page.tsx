...
const LOG_RELEASES = [
  ...
  },
  {
    ...
    type: 'Release',
    commits: [
      'Launched official Iconyx suite featuring 80 clean hand-drawn vector SVG icons.',
      'Organized 8 neat categories covering design elements, weather, commerce, data, devices, and UI utilities.',
