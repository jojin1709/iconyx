...
const icons = {
  arrows: {
    ...
    'redo':             `<polyline points="15 14 20 9 15 4"/><path d="M4 20v-7a4 4 0 0 0 4-4h12"/>`,
  ...
  ui: {
    ...
    'sort':             `<line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="16" y2="12"/><line x1="3" y1="18" x2="11" y2="18"/>`,
  ...
  social: {
    ...
    'twitter-x':        `<path d="M4 4l16 16"/><path d="M20 4L4 20"/>`,
    ...
    'discord':          `<circle cx="9" cy="12" r="1.5"/><circle cx="15" cy="12" r="1.5"/><path d="M7.5 7.5C9 7 10.5 6.5 12 6.5s3 .5 4.5 1M7.5 16.5C9 17 10.5 17.5 12 17.5s3-.5 4.5-1"/><path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515 14.45 14.45 0 0 0-.617 1.25 18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25A19.736 19.736 0 0 0 3.677 4.37C.533 9.046-.32 13.58.099 18.057a19.876 19.876 0 0 0 5.993 3.03 15.185 15.185 0 0 0 1.226-1.994 13.107 13.107 0 0 1-1.872-.892 10.2 10.2 0 0 0 .372-.292c3.928 1.793 8.18 1.793 12.062 0 .12.098.246.198.373.292a12.299 12.299 0 0 1-1.873.892 15.25 15.25 0 0 0 1.225 1.993 19.839 19.839 0 0 0 6.002-3.03c.5-5.177-.838-9.674-3.549-13.66z"/>`,
    'telegram':         `<path d="M21.198 2.433a2.242 2.242 0 0 0-1.022.215l-16.5 6.75a2.25 2.25 0 0 0 .126 4.238l3.322 1.025 1.47 4.584c.18.494.678.796 1.196.743l2.196-.5 2.23 2.003a2.22 2.22 0 0 0 2.98-.062 2.19 2.19 0 0 0 .648-1.53V4.637a2.22 2.22 0 0 0-2.646-2.204z"/>`,
  ...
  files: {
    ...
    'folder-open':      `<path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/><line x1="2" y1="10" x2="22" y2="10"/>`,
    ...
    'file-image':       `<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><circle cx="10" cy="13" r="2"/><polyline points="20 17 15 12 6 21"/>`,
  ...
  communication: {
    ...
    'mail-open':        `<path d="M2.5 8.5L12 14l9.5-5.5"/><path d="M2 17V8.5A2.5 2.5 0 0 1 4.5 6h15A2.5 2.5 0 0 1 22 8.5V17a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2z"/>`,
    ...
    'phone-call':       `<path d="M15.05 5A5 5 0 0 1 19 8.95M15.05 1A9 9 0 0 1 23 8.94m-1 7.98v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.56 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>`,
    'bell':             `<path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/>`,
    'bell-off':         `<path d="M13.73 21a2 2 0 0 1-3.46 0"/><path d="M18.63 13A17.888 17.888 0 0 1 18 8"/><path d="M6.26 6.26A5.86 5.86 0 0 0 6 8c0 7-3 9-3 9h14"/><path d="M18 8a6 6 0 0 0-9.33-5"/><line x1="1" y1="1" x2="23" y2="23"/>`,
...
Object.entries(icons).forEach(([category, categoryIcons]) => {
  const dir = path.join(__dirname, '..', 'public', 'icons', category);
  fs.mkdirSync(dir, { recursive: true });
  Object.entries(categoryIcons).forEach(([name, content]) => {
    const svg = SVG_WRAPPER(content);
...
console.log(`\n✅ Generated ${totalCreated} icons across ${Object.keys(icons).length} categories.`);
Object.entries(icons).forEach(([cat, icons]) => console.log(`  ${cat}: ${Object.keys(icons).length}`));
